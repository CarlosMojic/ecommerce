...
namespace ecomerce.Controllers
{
    ...
    public class departamentosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "departamento_id,nombre_departamento")] departamentos departamentos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "departamento_id,nombre_departamento")] departamentos departamentos)
        {
            if (ModelState.IsValid)
            {
